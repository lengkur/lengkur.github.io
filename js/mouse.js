!function (t, e) {
  'object' == typeof exports &&
    'undefined' != typeof module ? module.exports = e() : 'function' == typeof define &&
      define.amd ? define(e) : (t || self).MouseFollower = e()
}(
  this,
  function () {
    var t = /*#__PURE__*/ function () {
      ...
      return e.init = function () {
          ...
          this.event.mouseleave = function () {
            ...
            this.event.mouseover = function (e) {
              for (
                ...
                for (var s in t.options.stateDetection) i.matches(t.options.stateDetection[s]) &&
                  t.addState(s);
        ...
        e.toggleState = function (t, e) {
          !0 === e ||
            !1 !== e &&
            !this.el.classList.contains(t) ? this.addState(t) : this.removeState(t)
        },
        ...
        e.trigger = function (t) {
          var e = arguments,
            i = this;
          this.events[t] &&
            this.events[t].forEach(
              function (t) {
                return t.call.apply(t, [
                  i,
                  i
                ].concat([].slice.call(e, 1)))
              }
            )
        },
